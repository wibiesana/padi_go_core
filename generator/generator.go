...
func (g *Generator) generateBaseModel(tableName, modelName string, columns []ColumnInfo) error {
	...
	imports.WriteString("\t\"github.com/wibiesana/padi-core/activerecord\"\n")
...
%s`, imports.String(), modelName, fieldsCode.String(), modelName, tableName, modelName, pkCol, modelName, strings.Join(fillableCols, ", "), relationsMethod)
...
func (c *{{ModelName}}Controller) All(w http.ResponseWriter, r *http.Request) {
	...
	response.Items(w, records, "All {{ModelName}} retrieved successfully")
}
...
func (c *{{ModelName}}Controller) Show(w http.ResponseWriter, r *http.Request) {
	...
	response.Item(w, item, "{{ModelName}} retrieved successfully")
}
...
func (c *{{ModelName}}Controller) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.Item(w, item, "{{ModelName}} updated successfully")
}
